...
derived_collection_entry('MODULESTORE', 'default', 'OPTIONS', 'stores', 0, 'OPTIONS', 'fs_root')
derived_collection_entry('MODULESTORE', 'default', 'OPTIONS', 'stores', 1, 'OPTIONS', 'fs_root')
